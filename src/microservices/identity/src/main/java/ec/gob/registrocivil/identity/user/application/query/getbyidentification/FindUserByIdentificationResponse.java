...
import ec.gob.registrocivil.identity.profile.application.ProfileResponse;
...
public class FindUserByIdentificationResponse implements IResponse {
    ...
    public FindUserByIdentificationResponse(UUID id, String firstName, String lastName, String identification,
    ...
    public FindUserByIdentificationResponse(User user) {
