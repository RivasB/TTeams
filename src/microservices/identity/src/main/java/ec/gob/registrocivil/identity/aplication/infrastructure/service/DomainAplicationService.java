...
import ec.gob.registrocivil.identity.aplication.domain.rules.ApplicationAccessRequiredRule;
import ec.gob.registrocivil.identity.aplication.domain.rules.ApplicationNameMustBeUniqueRule;
import ec.gob.registrocivil.identity.aplication.domain.rules.ApplicationNameRequiredRule;
import ec.gob.registrocivil.identity.aplication.domain.rules.ApplicationStateRequiredRule;
...
public class DomainAplicationService implements IAplicationService {
    ...
    @Value("${kafka.messenger.aplication:false}")
