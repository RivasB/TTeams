package ec.gob.registrocivil.identity.profile.infrastructure.port;
...
import ec.gob.registrocivil.identity.profile.application.command.create.CreateProfileCommand;
import ec.gob.registrocivil.identity.profile.application.command.create.CreateProfileMessage;
import ec.gob.registrocivil.identity.profile.application.command.create.CreateProfileRequest;
import ec.gob.registrocivil.identity.profile.application.command.delete.DeleteProfileCommand;
import ec.gob.registrocivil.identity.profile.application.command.delete.DeleteProfileMessage;
import ec.gob.registrocivil.identity.profile.application.command.update.UpdateProfileCommand;
import ec.gob.registrocivil.identity.profile.application.command.update.UpdateProfileMessage;
import ec.gob.registrocivil.identity.profile.application.command.update.UpdateProfileRequest;
import ec.gob.registrocivil.identity.profile.application.query.getall.FindProfileWithFilterQuery;
import ec.gob.registrocivil.identity.profile.application.query.getbyid.FindProfileByIdQuery;
import ec.gob.registrocivil.identity.profile.application.query.getbyid.FindProfileByIdResponse;
