...
import ec.gob.registrocivil.identity.user.application.command.create.CreateUserCommand;
import ec.gob.registrocivil.identity.user.application.command.create.CreateUserMessage;
import ec.gob.registrocivil.identity.user.application.command.create.CreateUserRequest;
import ec.gob.registrocivil.identity.user.application.command.delete.DeleteUserCommand;
import ec.gob.registrocivil.identity.user.application.command.delete.DeleteUserMessage;
...
import ec.gob.registrocivil.identity.user.application.query.getall.FindUserWithFilterQuery;
import ec.gob.registrocivil.identity.user.application.query.getbyid.FindUserByIdQuery;
import ec.gob.registrocivil.identity.user.application.query.getbyid.FindUserByIdResponse;
