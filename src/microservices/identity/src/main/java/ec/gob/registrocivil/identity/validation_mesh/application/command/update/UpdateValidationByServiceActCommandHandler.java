...
@Component
public class UpdateValidationByServiceActCommandHandler
        implements ICommandHandler<UpdateValidationByServiceActCommand> {

    private final IValidationService validatinoService;

    public UpdateValidationByServiceActCommandHandler(IValidationService validatinoService) {
        this.validatinoService = validatinoService;
    }

    @Override
    public void handle(UpdateValidationByServiceActCommand command) {
