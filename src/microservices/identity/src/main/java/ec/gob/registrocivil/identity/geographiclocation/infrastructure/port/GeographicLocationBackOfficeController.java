package ec.gob.registrocivil.identity.geographiclocation.infrastructure.port;
...
import ec.gob.registrocivil.identity.geographiclocation.application.command.create.CreateGeographicLocationCommand;
import ec.gob.registrocivil.identity.geographiclocation.application.command.create.CreateGeographicLocationMessage;
import ec.gob.registrocivil.identity.geographiclocation.application.command.create.CreateGeographicLocationRequest;
import ec.gob.registrocivil.identity.geographiclocation.application.command.delete.DeleteGeographicLocationCommand;
import ec.gob.registrocivil.identity.geographiclocation.application.command.delete.DeleteGeographicLocationMessage;
import ec.gob.registrocivil.identity.geographiclocation.application.command.update.UpdateGeographicLocationCommand;
import ec.gob.registrocivil.identity.geographiclocation.application.command.update.UpdateGeographicLocationMessage;
