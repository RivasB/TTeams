package cloud.tteams.identity.agency.infrastructure.port;

import java.util.List;
import java.util.UUID;

import cloud.tteams.identity.agency.application.query.AgencyResponse;
import cloud.tteams.identity.agency.application.query.getall.FindAgencyWithFilterQuery;
import cloud.tteams.identity.agency.application.query.getbycanton.FindAgencyByCantonQuery;
import cloud.tteams.identity.agency.application.query.getbycanton.FindAgencyByCantonResponse;
import cloud.tteams.identity.agency.application.query.getbyid.FindAgencyByIdQuery;
import cloud.tteams.identity.agency.application.query.getbyid.FindAgencyByIdResponse;
import cloud.tteams.identity.agency.application.query.getbyprovince.FindAgencyByProvinceQuery;
import cloud.tteams.identity.agency.application.query.getbyprovince.FindAgencyByProvinceResponse;
...
import cloud.tteams.identity.agency.application.command.create.CreateAgencyCommand;
import cloud.tteams.identity.agency.application.command.create.CreateAgencyMessage;
import cloud.tteams.identity.agency.application.command.create.CreateAgencyRequest;
import cloud.tteams.identity.agency.application.command.delete.DeleteAgencyCommand;
import cloud.tteams.identity.agency.application.command.delete.DeleteAgencyMessage;
import cloud.tteams.identity.agency.application.command.update.UpdateAgencyCommand;
import cloud.tteams.identity.agency.application.command.update.UpdateAgencyMessage;
import cloud.tteams.identity.agency.application.command.update.UpdateAgencyRequest;
