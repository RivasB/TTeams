package ec.gob.registrocivil.share.core.infrastructure.bus.command;

import ec.gob.registrocivil.share.core.domain.bus.command.CommandHandlerExecutionError;
import ec.gob.registrocivil.share.core.domain.bus.command.CommandNotRegisteredError;
import ec.gob.registrocivil.share.core.domain.bus.command.ICommand;
import ec.gob.registrocivil.share.core.domain.bus.command.ICommandBus;
